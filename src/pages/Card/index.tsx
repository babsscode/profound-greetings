...
const Card: React.FC = () => {
    ...
    <section
        id="home"
        className="bg-[#b7cfc9] gap-16 py-2 min-h-screen overflow-auto pb-16 md:p-10 w-full md:pb-0 text-[#112621] items-center justify-center"
    >
   {!isCardOpen && (
    <div 
        className="bg-[#335F55] p-5 md:p-10 sm:h-[30rem] md:h-[40rem] w-[90%] mx-auto lg:w-2/5 text-[#335F55]" 
